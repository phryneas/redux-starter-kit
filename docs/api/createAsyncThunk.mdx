...
|-------------------|----------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|banana             |string                                                                                              |hi there guy                                                                                                                                                                                                                                                                                                |
|superDuperLongParam|boolean                                                                                             |Pass me in if you dare!                                                                                                                                                                                                                                                                                     |

```ts
export type Hi = 'banana'
```

<ApiDoc reference="@reduxjs/toolkit!createAsyncThunk:function(1)" render={({ paramsTable, signature }) => (
  <div>
    <Markdown>
    { paramsTable }
    </Markdown>

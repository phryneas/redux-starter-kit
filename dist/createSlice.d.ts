...
import { PayloadAction, PayloadActionCreator, PrepareAction, ActionCreatorWithoutPayload, _ActionCreatorWithPreparedPayload } from './createAction';
 ...
 * @internal
 */
declare type SliceDefinedCaseReducers<CaseReducers extends SliceCaseReducerDefinitions<any, any>> = {
    [Type in keyof CaseReducers]: CaseReducers[Type] extends {
